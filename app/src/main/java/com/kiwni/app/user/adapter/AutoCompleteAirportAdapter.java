...
public class AutoCompleteAirportAdapter extends ArrayAdapter<AutocompletePrediction> implements Filterable {

    private List<AutocompletePrediction> mResultList;
    private final PlacesClient placesClient;

    public AutoCompleteAirportAdapter(Context context, PlacesClient placesClient) {
