...
public class AirportFragment extends Fragment implements
        OnMapReadyCallback,
    ...
    AppCompatButton btnViewCabAirportPickup,  btnConfirm, btnAirportPickup, btnAirportDrop;//btnCurrentLocation, btnLocationOnMap,
    ...
    public static double pickup_lat = 0.0, pickup_lng = 0.0;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnViewCabAirportPickup = view.findViewById(R.id.btnViewCabAirportPickup);
       ...
       // btnLocationOnMap = view.findViewById(R.id.btnLocationOnMap);
        ...
        btnAirportPickup = view.findViewById(R.id.btnAirportPickup);
        btnAirportDrop = view.findViewById(R.id.btnAirportDrop);
        ...
        btnAirportPickup.setBackgroundResource(R.drawable.tab_outstation_color);
        btnAirportPickup.setTextColor(Color.WHITE);
        ...
        btnAirportPickup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                direction = "airport-pickup";
                btnAirportPickup.setBackgroundResource(R.drawable.tab_outstation_color);
                btnAirportPickup.setTextColor(Color.WHITE);
                btnAirportDrop.setBackgroundResource(R.drawable.border_black_for_tab);
                btnAirportDrop.setTextColor(getActivity().getResources().getColor(R.color.button_color_dark));
            }
        });

        btnAirportDrop.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                direction = "airport-drop";

                btnAirportDrop.setBackgroundResource(R.drawable.tab_outstation_color);
                btnAirportDrop.setTextColor(Color.WHITE);
                btnAirportPickup.setBackgroundResource(R.drawable.border_black_for_tab);
                btnAirportPickup.setTextColor(getActivity().getResources().getColor(R.color.button_color_dark));
        ...
        autoCompleteTextViewPickup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                    ...
                    public void onClick(View view) {
                       ...
                       // linearFooterButtons.setVisibility(View.GONE);
                                ...
                                && !autoCompleteTextViewDrop.getText().toString().equals(""))
                        {
                            ...
                            btnViewCabAirportPickup.setVisibility(View.VISIBLE);
                        }
                        else
                        {
                            linearBtnConfirm.setVisibility(View.GONE);
               ...
               // linearFooterButtons.setVisibility(View.VISIBLE);
                ...
                linearBtnConfirm.setVisibility(View.GONE);
                btnViewCabAirportPickup.setVisibility(View.GONE);
       ...
       /* autoCompleteTextViewDrop.setOnTouchListener(new View.OnTouchListener() {
        ...
        btnViewCabAirportPickup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view)
            {
                //one-way
                            ...
                            try
                            {
                                ...
                                else
                                {
                                    if(direction.equals("airport-pickup")) {
                                        ...
                                        PreferencesUtils.putPreferences(getActivity(), SharedPref.SERVICE_TYPE, "Airport");
    ...
    public void onConnected(@Nullable Bundle bundle)
    {
        ...
        if (mLastLocation != null)
        {
            ...
            /*pickup_lat = currentLatitude;
            pickup_lng = currentLongitude;*/

            Log.d("TAG","pickup_lat"+pickup_lat);
    ...
    private void drawRoute()
    {
        ...
        AirportFragment.DownloadDirectionTask downloadTask = new AirportFragment.DownloadDirectionTask();
    ...
    private class DownloadDirectionTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            AirportFragment.DirectionParseTask parserTask = new AirportFragment.DirectionParseTask();
    ...
    private void GetDistance(LatLng mOrigin, LatLng mDestination) {
        ...
        AirportFragment.DownloadAndDistanceParseTask distanceTask = new AirportFragment.DownloadAndDistanceParseTask();
