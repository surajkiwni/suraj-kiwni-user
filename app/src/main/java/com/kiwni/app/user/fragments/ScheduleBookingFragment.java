...
public class ScheduleBookingFragment extends Fragment implements
        OnMapReadyCallback,
        ...
        ConnectivityHelper.NetworkStateReceiverListener
{
    ...
    AppCompatButton btnRentalScheduleViewCab, btnCurrentLocation, btnLocationOnMap, btnConfirm;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
    {
        ...
        btnRentalScheduleViewCab = view.findViewById(R.id.btnRentalScheduleViewCab);
        ...
        autoCompleteTextViewPickup.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event)
            {
                ...
                btnRentalScheduleViewCab.setVisibility(View.GONE);
        ...
        btnCurrentLocation.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                        ...
                        && !autoCompleteTextViewDrop.getText().toString().equals(""))
                {
                    ...
                    linearBtnConfirm.setVisibility(View.GONE);
                    btnRentalScheduleViewCab.setVisibility(View.VISIBLE);
                }
                else
                {
                    linearBtnConfirm.setVisibility(View.GONE);
        ...
        btnRentalScheduleViewCab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
